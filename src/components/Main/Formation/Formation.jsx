...
export default function Formation({ darkMode }) {
  return (
    <div id="formation" className="text-lg leading-5 xl:text-xl">
      ...
      <p className="flex items-baseline mt-8">
        ...
        <img
          className="w-28 ml-2"
          src={darkMode ? '/oclockLight.png' : '/oclockDark.png'}
          alt=""
        />
      </p>
      ...
      <Frontend darkMode={darkMode} />
      <Backend darkMode={darkMode} />
      <Management darkMode={darkMode} />
      <Notices darkMode={darkMode} />
    </div>
  );
}
